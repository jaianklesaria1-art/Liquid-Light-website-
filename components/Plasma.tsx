...
const Plasma: React.FC<PlasmaProps> = ({
  ...
  useEffect(() => {
    ...
    // Initial uniform setup using the current color ref
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uCustomColor: { value: new Float32Array(currentColorRef.current) },
    ...
    const loop = (t: number) => {
      ...
      // Small factor for very smooth transition over frames
      ...
      // Update uniform with new color values
      program.uniforms.uCustomColor.value = new Float32Array(current);
  ...
  }, [speed, direction, scale, opacity, mouseInteractive]); // Removed 'color' dependency to prevent remounting
